 ...
 * @author clarkc
 */
public class AdmitDischargeTransfer_A08 extends AdmitDischargeTransfer
{

    private final ADT_A08 adt;
    private static final String TRIGGER_EVENT = "A08";
    private static final String MESSAGE_STRUCTURE = "ADT_A01";

    public ADT_A08 getAdt()
    {
        return adt;
    }

    public AdmitDischargeTransfer_A08(IheActorConfiguration actor, DomainIdentifier identifier, IheIdentification localIdentification, PersonDemographic patient, PV1Class pv1Class) throws HL7Exception
    {
        super(actor, identifier, localIdentification, patient);

        this.adt = new ADT_A08();
    ...
    private void fillMshA08() throws HL7Exception
    {
