 ...
 * @author Nebri
 */
public abstract class V25Message extends PixMessage {

    public V25Message(IheActorConfiguration actor, DomainIdentifier identifier, IheIdentification localIdentification) {
    ...
    protected void fillStandardMsh(MSH msh) throws DataTypeException, HL7Exception {
        ...
        // Change to ts
        msh.getMsh7_DateTimeOfMessage().getTs1_Time().setValue(ft.format(creationDate));
