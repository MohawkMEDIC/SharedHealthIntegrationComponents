 ...
 * @author Garrett
 */
public class AdmitDischargeTransfer_A05 extends AdmitDischargeTransfer
{

    private final ADT_A04 adt;
    private static final String TRIGGER_EVENT = "A05";
    private static final String MESSAGE_STRUCTURE = "ADT_A01";

    public AdmitDischargeTransfer_A05(IheActorConfiguration actor, DomainIdentifier identifier, IheIdentification localIdentification, PersonDemographic patient, PV1Class pv1Class) throws HL7Exception
    {
