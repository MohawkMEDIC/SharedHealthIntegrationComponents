...
public class XdsSamlTesting {
    ...
    private static final Logger LOGGER = Logger.getLogger(XdsSamlTesting.class.getName());
...
//        affDom = config.getAffinityDomain(TEST_AFFINITY_DOMAIN);
        ...
        TestPatient2.addIdentifier(new DomainIdentifier("1.19.6.24.109.42.1.3", "4481f0381c6849d"));
        ...
        try {
            ...
            config.setKeyStore(new JKSStoreInformation("C:\\vuk\\stores\\keystore.jks", "changeit"));
            config.setTrustStore(new JKSStoreInformation("C:\\vuk\\stores\\truststore.jks", "changeit"));
...
//        System.setProperty("javax.net.debug", "all");
    ...
    public void testRetrieveDocument() {
        ...
        try {
            ...
            for (DocumentMetaData documentMetaData : xds.retrieveDocumentSet(xds.findDocuments(TestPatient2))) {
